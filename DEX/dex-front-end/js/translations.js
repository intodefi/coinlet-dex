(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.translations = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(_dereq_,module,exports){
module.exports = {
  en: {
    en: 'English',
    cn: 'English',
  ...
  description: {
    en: 'BitDex is a decentralized exchange for Ethereum tokens.',
    cn: 'BitDex是去中心化的以太坊交易平台。',
    fr: "BitDex est une bourse d'échange de jetons ethereum décentralisé.",
    es: 'BitDex se ha posicionado como la primera bolsa de cambio de cryptomonedas y tokens de la blockchain Ethereum.',
    // cn:'BitDex是无中心的以太坊交易平台。'
  },
  Smart_Contract: {
    en: 'Smart Contract',
    cn: '智能合约',
  ...
  only_7_days: {
    en: 'Note: BitDex will only show recent transactions.',
    cn: '注意：BitDex只会显示最近的交易。',
    fr: 'Remarque: BitDex affichera uniquement les transactions récentes.',
    es: 'Nota: BitDex sólo mostrará transacciones recientes.',
  },
  ...
  etherdelta_desc: {
    en: 'BitDex &#8212; decentralized token exchange',
    cn: 'BitDex &#8212; 去中心化交易',
    // cn:'BitDex &#8212; 无中心交易'
    fr: 'BitDex &#8212; échange de jetons décentralisé',
    es: 'BitDex &#8212; échange de jetons décentralisé',
  },
  etheropt_desc: {
  ...
  aug032016_announcement: {
    en: 'BitDex has moved to a new smart contract. Go to the bottom of the page and switch to the old one if you have a balance there you need to withdraw.',
    cn: 'BitDex更新了智能合约。如果你要提取余额，请到本页底部转成旧的合约并进行提取。',
    fr: "BitDex a ete modifié pour un nouveau smart contract. Allez au bas de page et permutez le avec l'ancien s'il reste du solde à retirer.",
  },
  aug302016: {
    en: 'August 30, 2016',
    cn: '2016年8月3日',
  ...
  aug302016_announcement: {
    en: 'BitDex has moved to a new smart contract. Go to the bottom of the page and switch to the old one if you have a balance there you need to withdraw.',
    cn: 'BitDex更新了智能合约。如果你要提取余额，请到本页底部转成旧的合约并进行提取。',
    // cn:'BitDex迁移到了新的智能合约。如果你要提取余额，请到本页底部转成旧的。'
    fr: "BitDex utilise un nouveau smart contract. Allez au bas de page et permutez le avec l'ancien s'il vous reste du solde à retirer.",
    es: 'BitDex utiliza un nuevo contrato inteligente.',
  },
  new_account: {
    en: 'New account',
    cn: '新账号',
  ...
  deposit_withdraw_2: {
    en: 'Under "Balances," you will see your balance for each of the two currencies you selected. This is the balance you have deposited to BitDex from your Ethereum account.',
  ...
  deposit_withdraw_4: {
    en: 'To deposit, click the "Deposit" tab, pick a token, enter an amount you would like to deposit from your Ethereum account into BitDex, and click "Deposit."',
    cn: '充值点“充值”，选择一种币，输入从以太坊账号进入BitDex的充值数量，再点“充值”。',
  ...
  trade_3: {
    en: 'BitDex supports resting orders (adding liquidity) and trading against existing resting orders (taking liquidity).',
    cn: 'BitDex支持“待定下单”（resting order）来增加流动性，以及交易“待定下单”来减少流动性。',
    fr: "BitDex supportes les ordres restant (l'ajout de liquidite) et marchander contre des ordres restant (prise de liquidite).",
    es: 'BitDex apoya descansando órdenes tales como la adición de liquidez y el comercio contre órdenes existentes como descansando Tomando liquidez..',
  },
  trade_4: {
  ...
  trade_6: {
    en: 'When you submit a resting order, it gets broadcast to the world. The current broadcast channel is a Gitter chat room, but BitDex also supports using Ethereum events as a fallback broadcast mechanism.',
    cn: '但你提交了一个“待定下单”后，它会广播到全球。现在的传播渠道是Gitter聊天室，但是BitDex也支持以太坊事件机制，用来保底。',
